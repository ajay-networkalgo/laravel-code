    ...
    <div
        ...
        <div class="flex flex-col lg:flex-row gap-10 md:gap-[90px]">
            <div class="lg:w-[50%] flex flex-col gap-10 relative lg:sticky top-[10%] h-full">
                <div class="relative">
                    <button onclick="prevImage()" class="absolute left-0 top-1/2 transform -translate-y-1/2  text-primary-black bg-[#F5F5F5] p-2 rounded-full">←</button>
                    ...
                    <button onclick="nextImage()" class="absolute right-0 top-1/2 transform -translate-y-1/2 text-primary-black p-2 bg-[#F5F5F5] rounded-full">→</button>
                </div>
