      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="{{ route('page.save') }}" method="post" id="addPageForm" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="meta_title" id="meta_title" placeholder="Enter title">
                    @error('meta_title')
                      <div class="error">{{ $message }}</div>
                    @enderror
                  </div>
