        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('user.add') }}" class="btn btn-primary" style="float:right;">Add user</a>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#user_list').DataTable().on('click', '.deleteRecord', function (e) { 
      var id = $(this).attr('id');
      Swal.fire({
        title: 'Are you sure?',
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: siteUrl+"admin/user-management/delete",
            type: "post",
            data: {
              rowid: id
            },
    ...
    $('#user_list').DataTable().on('click', '.changeStatus', function (e) {
      var id = $(this).attr('id');
      ...
      .then((result) => {
        if (result.isConfirmed) {
          $.ajax({
            url: siteUrl+"admin/user-management/changestatus",
            type: "post",
            data: {
