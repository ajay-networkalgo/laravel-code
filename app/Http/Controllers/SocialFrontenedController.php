...
class SocialFrontenedController extends Controller
{
    ...
    public function saveContactUs(Request $request)
    {
        ...
        try {
            ...
            $phoneNumber = $input['countryCode'] . $input['phone'];
            $contactUs = ContactUs::create([
                ...
                'name' => $input['fullName'],
                'email' => $input['email'],
                'phone_number' => $input['countryCode'] . $input['phone'],
            ...
            if ($contactUs) {
                ...
                return response()->json([
                    'success' => true,
                    'message' => 'Thank you for your enquiry! Our representive will contact with you soon.',
                    'data' => $contactUs  // Send back the new award data
                ]);
    ...
    public function verifyOtp(Request $request)
    {
        ...
        $contactUs = ContactUs::where('otp', $otp)->first();
        
        if ($contactUs) {
            $contactUs->otp = $otp;
            $contactUs->is_verified_otp = $status;
            $contactUs->save();
            
            return response()->json(['message' => 'Thank you for your enquiry! Our representive will contact with you soon.']);
        } else {
