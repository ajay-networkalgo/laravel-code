      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="{{ route('events.save') }}" method="post" id="addEventsForm" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group date custom_from_date_message" id="reservationfromdate" data-target-input="nearest">
                      <input type="text" id="from_date" name="from_date" class="form-control datetimepicker-input" data-target="#reservationfromdate" value="{{ old('from_date') }}" />
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group date custom_to_date_message" id="reservationtodate" data-target-input="nearest">
                      <input type="text" id="to_date" name="to_date" class="form-control datetimepicker-input" data-target="#reservationtodate" value="{{ old('to_date') }}"/>
