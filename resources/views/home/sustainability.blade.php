            ...
            <div
                ...
                <div class="flex flex-col lg:w-[45%]">
                    <div class="flex flex-col gap-6">
                        ...
                        <span
                            class="text-primary-black font-secondary font-base leading-[24px]">At Olax Power, our mission is to empower energy independence through innovative, reliable, and sustainable energy storage solutions. We are dedicated to advancing renewable energy efficiency and driving the global shift towards a cleaner, greener future.</span>
                    </div>
                </div>
            </div>
