        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('news.add') }}" class="btn btn-primary" style="float:right;">Add news</a>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#news_list').DataTable().on('click', '.deleteRecord', function (e) { 
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            type: "DELETE",
            url: siteUrl+"admin/news/delete/"+newsId,
            data: {
                _token: '{{ csrf_token() }}'
            },
